...
namespace Services.Business.Handlers.Command
{
    ...
    {
        private readonly IVmsLogger<UpdateBusinessDetailsHandler> _logger;
        private readonly IBusinessRepository _repository;
        private readonly IServiceBusMessagePublisher _publisher;

        public UpdateBusinessDetailsHandler(IVmsLogger<UpdateBusinessDetailsHandler> logger, IBusinessRepository repository, IServiceBusMessagePublisher publisher)
        {
            _logger = logger;
